...
public class FormPretragaTermina extends javax.swing.JDialog {
    ...
    public FormPretragaTermina(java.awt.Frame parent, boolean modal) {
        ...
        setTitle("Pretraga termini");
        
        models.TableStyle.applyTableStyle(tblTermini);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pretraga (ime i prezime pacijenta):");
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            try {
                ...
                JOptionPane.showMessageDialog(this,
                        "Sistem ne može da pronađe termin.",
                        "Greška",
