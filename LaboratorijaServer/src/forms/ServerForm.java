...
public class ServerForm extends javax.swing.JFrame {
    ...
    public ServerForm() {
        ...
        btnPokreniServer.setBackground(new Color(52, 152, 219));
        btnPokreniServer.setForeground(Color.WHITE);
        btnUgasiServer.setBackground(new Color(231, 76, 60));
        btnUgasiServer.setForeground(Color.WHITE);
    }
    ...
    private void btnPokreniServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPokreniServerActionPerformed
        if (threadServer == null || !threadServer.isAlive()) {
            ...
            lblServerStatus.setForeground(new Color(46, 204, 113)); // zelena boja
